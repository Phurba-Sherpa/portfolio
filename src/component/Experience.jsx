...
export default function Experience() {
    return (
        <section className="container h-full mt-12" id="experience">
            <div className="mb-12 text-center lg:mb-24">
                <h1 className="main-head">Experience</h1>
                <p className="text-base">
                    Here you will find more information about time line of
                    professional experiences with industry till today.
                </p>
            </div>
            <div className="exp-container">
                {experiences.map((exp) => (
                    <ExpComp experience={exp} key={exp.company} />
                ))}
            </div>
        </section>
    )
